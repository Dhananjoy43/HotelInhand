...
const SERVER = "https://hotalinhandbackend.onrender.com";
    ...
    useEffect(() => {
        return async () => {
            try {
                setloading(true);
                const Data = (
                    await axios.get(`${SERVER}/api/bookings/getallbookings`)
                ).data;
                setbookings(Data);
                setloading(false);
            } catch (error) {
    ...
    useEffect(() => {
        return async () => {
            try {
                setloading(true);
                const roomData = (
                    await axios.get(`${SERVER}/api/rooms/getallrooms`)
                ).data;
                setrooms(roomData);
                setloading(false);
            } catch (error) {
...
export function Addroom() {
    ...
    async function addRoom() {
        ...
        try {
            const result = await (
                await axios.post(`${SERVER}/api/rooms/addroom`, newroom)
            ).data;
            console.log(result);
    ...
    useEffect(() => {
        return async () => {
            try {
                setloading(true);
                const Data = (
                    await axios.get(`${SERVER}/api/users/getallusers`)
                ).data;
                setusers(Data);
                setloading(false);
            } catch (error) {
